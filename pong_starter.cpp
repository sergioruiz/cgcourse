...
void init() // FOR GLUT LOOP
{
	...
	type = 0;	// initialize global variable
...
void display()							// Called for each frame (about 60 times per second).
{
	...
	glBegin(GL_POLYGON);
	{
		...
		glVertex3f(xLeft + 1.0f, yLeft, 0);
		glVertex3f(xLeft + 1.0f, yLeft + 3.0f, 0);
		glVertex3f(xLeft, yLeft + 3.0f, 0);
	}
	glEnd();
